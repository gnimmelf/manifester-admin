var MyUiComponents = (function (exports,_react,reactDom,_propTypes,history,reactstrap) {
'use strict';
...
_propTypes = _propTypes && _propTypes.hasOwnProperty('default') ? _propTypes['default'] : _propTypes;
...
!function(root, factory) {
    ...
    return function(modules) {
        ...
        var _extends = Object.assign || function(target) {
            ...
            return target;
        }, _propTypes$$1 = __webpack_require__(0), _propTypes2 = function(obj) {
            return obj && obj.__esModule ? obj : {
                default: obj
            };
        }(_propTypes$$1), stringOrNumber = _propTypes2.default.oneOfType([ _propTypes2.default.string, _propTypes2.default.number ]), matchers = {
...
var Link = function (_React$Component) {
  ...
  function Link() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Link.__proto__ || Object.getPrototypeOf(Link)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
  ...
  createClass(Link, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = objectWithoutProperties(_props, ['href', 'children']);

      return _react.createElement(
        'a',
        _extends({ href: href }, props, { onClick: this.handleClick }),
        children
      );
    }
  }]);
...
var NavbarBrand = (function (_ref) {
  ...
  return React.createElement(Link, _extends({ className: "navbar-brand " + (className || '') }, props));
});
...
unwrapExports(lib$1);
var lib_1 = lib$1.compose;
var lib_2 = lib$1.merge;
var lib_3 = lib$1.$;
var lib_4 = lib$1.style;
var lib_5 = lib$1.presets;
var lib_6 = lib$1.keyframes;
var lib_7 = lib$1.fontFace;
var lib_8 = lib$1.insertGlobal;
var lib_9 = lib$1.insertRule;
var lib_10 = lib$1.plugins;
var lib_11 = lib$1.styleSheet;
var lib_12 = lib$1.speedy;
var lib_13 = lib$1.simulations;
var lib_14 = lib$1.simulate;
var lib_15 = lib$1.cssLabels;
var lib_16 = lib$1.isLikeRule;
var lib_17 = lib$1.idFor;
var lib_18 = lib$1.css;
var lib_19 = lib$1.rehydrate;
var lib_20 = lib$1.flush;
var lib_21 = lib$1.select;
var lib_22 = lib$1.parent;
var lib_23 = lib$1.media;
var lib_24 = lib$1.pseudo;
var lib_25 = lib$1.active;
var lib_26 = lib$1.any;
var lib_27 = lib$1.checked;
var lib_28 = lib$1.disabled;
var lib_29 = lib$1.empty;
var lib_30 = lib$1.enabled;
var lib_31 = lib$1._default;
var lib_32 = lib$1.first;
var lib_33 = lib$1.firstChild;
var lib_34 = lib$1.firstOfType;
var lib_35 = lib$1.fullscreen;
var lib_36 = lib$1.focus;
var lib_37 = lib$1.hover;
var lib_38 = lib$1.indeterminate;
var lib_39 = lib$1.inRange;
var lib_40 = lib$1.invalid;
var lib_41 = lib$1.lastChild;
var lib_42 = lib$1.lastOfType;
var lib_43 = lib$1.left;
var lib_44 = lib$1.link;
var lib_45 = lib$1.onlyChild;
var lib_46 = lib$1.onlyOfType;
var lib_47 = lib$1.optional;
var lib_48 = lib$1.outOfRange;
var lib_49 = lib$1.readOnly;
var lib_50 = lib$1.readWrite;
var lib_51 = lib$1.required;
var lib_52 = lib$1.right;
var lib_53 = lib$1.root;
var lib_54 = lib$1.scope;
var lib_55 = lib$1.target;
var lib_56 = lib$1.valid;
var lib_57 = lib$1.visited;
var lib_58 = lib$1.dir;
var lib_59 = lib$1.lang;
var lib_60 = lib$1.not;
var lib_61 = lib$1.nthChild;
var lib_62 = lib$1.nthLastChild;
var lib_63 = lib$1.nthLastOfType;
var lib_64 = lib$1.nthOfType;
var lib_65 = lib$1.after;
var lib_66 = lib$1.before;
var lib_67 = lib$1.firstLetter;
var lib_68 = lib$1.firstLine;
var lib_69 = lib$1.selection;
var lib_70 = lib$1.backdrop;
var lib_71 = lib$1.placeholder;
var lib_72 = lib$1.cssFor;
var lib_73 = lib$1.attribsFor;
...
var constant_1 = constant.POSITION;
var constant_2 = constant.TYPE;
var constant_3 = constant.ACTION;
...
var trackProgress = lib$1.css.keyframes({
  '0%': { width: '100%' },
  '100%': { width: 0 }
});

var styles = function styles(type, isRunning, hide, delay, rtl) {
  return (0, lib$1.css)(_extends({
    position: 'absolute',
    bottom: 0,
    width: 0,
    height: '5px',
...
function ProgressBar(_ref) {
  ...
  return _react2.default.createElement('div', _extends({}, (0, lib$1.css)(styles(type, isRunning, hide, delay, rtl), typeof className !== 'string' && className), typeof className === 'string' && { className: className }, {
  ...
  _createClass(Toast, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          _extends({}, (0, lib$1.css)(styles.container(type, rtl), typeof className !== 'string' && className), this.getToastProps()),
          _react2.default.createElement(
            'div',
            _extends({}, this.props.in && { role: role }, (0, lib$1.css)(styles.body, typeof bodyClassName !== 'string' && bodyClassName), typeof bodyClassName === 'string' && {
...
Toast.propTypes = {
  ...
  closeToast: _propTypes2.default.func.isRequired,
  position: _propTypes2.default.oneOf((0, propValidator.objectValues)(constant.POSITION)).isRequired,
  ...
  type: _propTypes2.default.oneOf((0, propValidator.objectValues)(constant.TYPE)),
  className: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.object]),
...
function getAnimation(pos) {
  switch (pos) {
    case constant.POSITION.TOP_RIGHT:
    case constant.POSITION.BOTTOM_RIGHT:
    default:
      return {
        enter: {
          from: {
    ...
    case constant.POSITION.TOP_LEFT:
    case constant.POSITION.BOTTOM_LEFT:
      return {
        enter: {
          '0%': {
            opacity: 0,
    ...
    case constant.POSITION.BOTTOM_CENTER:
      return {
        enter: {
          from: {
            opacity: 0,
    ...
    case constant.POSITION.TOP_CENTER:
      return {
        enter: {
          '0%': {
            opacity: 0,
...
var styles = function styles(pos) {
  ...
  var enterAnimation = lib$1.css.keyframes(_extends({
    'from, 60%, 75%, 90%, to': {
  ...
  var exitAnimation = lib$1.css.keyframes(exit);

  return {
    enter: (0, lib$1.css)(_extends({}, animate, { animationName: enterAnimation })),
    exit: (0, lib$1.css)(_extends({}, animate, { animationName: exitAnimation }))
  };
};
...
var getToastPositionStyle = function getToastPositionStyle(pos) {
  ...
  var positionRule = typeof constant.POSITION[positionKey] !== 'undefined' ? _defaultStyle2.default[positionKey] : _defaultStyle2.default.TOP_RIGHT;
...
var ToastContainer = function (_Component) {
  ...
  _createClass(ToastContainer, [{
    ...
    value: function componentDidMount() {
      ...
      var SHOW = constant.ACTION.SHOW,
          CLEAR = constant.ACTION.CLEAR,
          MOUNTED = constant.ACTION.MOUNTED;
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _EventManager2.default.off(constant.ACTION.SHOW);
      _EventManager2.default.off(constant.ACTION.CLEAR);
    ...
    value: function renderToast() {
      ...
      return Object.keys(toastToRender).map(function (position) {
        ...
        return _react2.default.createElement(
          ...
          _extends({}, (0, lib$1.css)(styles(disablePointer, position, _this5.props.rtl), typeof className !== 'string' && className), typeof className === 'string' && { className: className }, style !== null && { style: style }, {
...
ToastContainer.propTypes = {
   ...
   * Set toast position
   */
  position: _propTypes2.default.oneOf((0, propValidator.objectValues)(constant.POSITION)),
...
function emitEvent(content, options) {
  if (container !== null) {
    _EventManager2.default.emit(constant.ACTION.SHOW, content, options);
  } else {
    queue.push({ action: constant.ACTION.SHOW, content: content, options: options });
  }
...
var toaster = _extends(function (content, options) {
  ...
  dismiss: function dismiss() {
    ...
    return container && _EventManager2.default.emit(constant.ACTION.CLEAR, id);
  },
 ...
 */
_EventManager2.default.on(constant.ACTION.MOUNTED, function (containerInstance) {
...
unwrapExports(lib$2);
var lib_1$1 = lib$2.style;
var lib_2$1 = lib$2.toast;
var lib_3$1 = lib$2.ToastContainer;
...
var FontAwesome = (function (_ref) {
  var _ref$icon = _ref.icon,
      ...
      props = objectWithoutProperties(_ref, ["icon", "iconStyle"]);

  console.assert(styles[iconStyle], "Unknown FontAwesome iconStyle: " + iconStyle);

  return React.createElement("i", _extends({ className: styles[iconStyle] + " fa-" + icon }, props));
});
...
exports.ToastContainer = lib_3$1;
exports.toast = lib_2$1;
exports.style = lib_1$1;
